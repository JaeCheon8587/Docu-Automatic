...
1. Agent(docu-writer) 생성
   prompt에 draft_path 포함: "{target}/.pipeline-temp/draft-getting-started--intro.md"
...
```
Agent(docu-writer "getting-started/intro") + Agent(docu-writer "getting-started/requirements") 동시 호출
